cmd_lib/efi_loader/efi_setup.o := aarch64-phytec-linux-gcc  --sysroot=/home/jma/phytec_works/iMX8MM.test_image/build/tmp/work/phyboard_polis_imx8mm_4-phytec-linux/u-boot-imx/2021.04-r0/recipe-sysroot -Wp,-MD,lib/efi_loader/.efi_setup.o.d  -nostdinc -isystem /home/jma/phytec_works/iMX8MM.test_image/build/tmp/work/phyboard_polis_imx8mm_4-phytec-linux/u-boot-imx/2021.04-r0/recipe-sysroot-native/usr/bin/aarch64-phytec-linux/../../lib/aarch64-phytec-linux/gcc/aarch64-phytec-linux/10.2.0/include -Iinclude  -I../include  -I../arch/arm/include -include ../include/linux/kconfig.h  -I../lib/efi_loader -Ilib/efi_loader -D__KERNEL__ -D__UBOOT__ -Wall -Wstrict-prototypes -Wno-format-security -fno-builtin -ffreestanding -std=gnu11 -fshort-wchar -fno-strict-aliasing -fno-PIE -Os -fno-stack-protector -fno-delete-null-pointer-checks -Wno-stringop-truncation -Wno-maybe-uninitialized -fmacro-prefix-map=../= -g -fstack-usage -Wno-format-nonliteral -Wno-address-of-packed-member -Wno-unused-but-set-variable -Werror=date-time -DHOST_ARCH="0x8664" -D__ARM__ -fno-pic -mstrict-align -ffunction-sections -fdata-sections -fno-common -ffixed-r9 -fno-common -ffixed-x18 -pipe -march=armv8-a -D__LINUX_ARM_ARCH__=8 -mgeneral-regs-only    -DKBUILD_BASENAME='"efi_setup"'  -DKBUILD_MODNAME='"efi_setup"' -c -o lib/efi_loader/efi_setup.o ../lib/efi_loader/efi_setup.c

source_lib/efi_loader/efi_setup.o := ../lib/efi_loader/efi_setup.c

deps_lib/efi_loader/efi_setup.o := \
    $(wildcard include/config/efi/platform/lang/codes.h) \
    $(wildcard include/config/efi/secure/boot.h) \
    $(wildcard include/config/efi/have/capsule/update.h) \
    $(wildcard include/config/efi/have/capsule/support.h) \
    $(wildcard include/config/efi/capsule/on/disk.h) \
    $(wildcard include/config/efi/capsule/firmware/management.h) \
    $(wildcard include/config/nr/dram/banks.h) \
    $(wildcard include/config/partitions.h) \
    $(wildcard include/config/efi/rng/protocol.h) \
    ...
    $(wildcard include/config/efi/capsule/on/disk/early.h) \
  ...
  ../include/efi_variable.h \
    $(wildcard include/config/efi/var/buf/size.h) \
...
lib/efi_loader/efi_setup.o: $(deps_lib/efi_loader/efi_setup.o)
