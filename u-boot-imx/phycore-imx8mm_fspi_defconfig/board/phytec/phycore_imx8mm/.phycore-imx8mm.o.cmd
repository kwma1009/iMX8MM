cmd_board/phytec/phycore_imx8mm/phycore-imx8mm.o := aarch64-phytec-linux-gcc  --sysroot=/home/jma/phytec_works/iMX8MM.test_image/build/tmp/work/phyboard_polis_imx8mm_4-phytec-linux/u-boot-imx/2021.04-r0/recipe-sysroot -Wp,-MD,board/phytec/phycore_imx8mm/.phycore-imx8mm.o.d  -nostdinc -isystem /home/jma/phytec_works/iMX8MM.test_image/build/tmp/work/phyboard_polis_imx8mm_4-phytec-linux/u-boot-imx/2021.04-r0/recipe-sysroot-native/usr/bin/aarch64-phytec-linux/../../lib/aarch64-phytec-linux/gcc/aarch64-phytec-linux/10.2.0/include -Iinclude  -I../include  -I../arch/arm/include -include ../include/linux/kconfig.h  -I../board/phytec/phycore_imx8mm -Iboard/phytec/phycore_imx8mm -D__KERNEL__ -D__UBOOT__ -Wall -Wstrict-prototypes -Wno-format-security -fno-builtin -ffreestanding -std=gnu11 -fshort-wchar -fno-strict-aliasing -fno-PIE -Os -fno-stack-protector -fno-delete-null-pointer-checks -Wno-stringop-truncation -Wno-maybe-uninitialized -fmacro-prefix-map=../= -g -fstack-usage -Wno-format-nonliteral -Wno-address-of-packed-member -Wno-unused-but-set-variable -Werror=date-time -D__ARM__ -fno-pic -mstrict-align -ffunction-sections -fdata-sections -fno-common -ffixed-r9 -fno-common -ffixed-x18 -pipe -march=armv8-a -D__LINUX_ARM_ARCH__=8 -mgeneral-regs-only    -DKBUILD_BASENAME='"phycore_imx8mm"'  -DKBUILD_MODNAME='"phycore_imx8mm"' -c -o board/phytec/phycore_imx8mm/phycore-imx8mm.o ../board/phytec/phycore_imx8mm/phycore-imx8mm.c

source_board/phytec/phycore_imx8mm/phycore-imx8mm.o := ../board/phytec/phycore_imx8mm/phycore-imx8mm.c

deps_board/phytec/phycore_imx8mm/phycore-imx8mm.o := \
...
board/phytec/phycore_imx8mm/phycore-imx8mm.o: $(deps_board/phytec/phycore_imx8mm/phycore-imx8mm.o)
