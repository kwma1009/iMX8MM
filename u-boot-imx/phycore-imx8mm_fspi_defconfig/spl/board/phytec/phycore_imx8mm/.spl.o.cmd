cmd_spl/board/phytec/phycore_imx8mm/spl.o := aarch64-phytec-linux-gcc  --sysroot=/home/jma/phytec_works/iMX8MM.test_image/build/tmp/work/phyboard_polis_imx8mm_4-phytec-linux/u-boot-imx/2021.04-r0/recipe-sysroot -Wp,-MD,spl/board/phytec/phycore_imx8mm/.spl.o.d  -nostdinc -isystem /home/jma/phytec_works/iMX8MM.test_image/build/tmp/work/phyboard_polis_imx8mm_4-phytec-linux/u-boot-imx/2021.04-r0/recipe-sysroot-native/usr/bin/aarch64-phytec-linux/../../lib/aarch64-phytec-linux/gcc/aarch64-phytec-linux/10.2.0/include -Ispl/include -Iinclude  -I../include  -I../arch/arm/include -include ../include/linux/kconfig.h  -I../board/phytec/phycore_imx8mm -Ispl/board/phytec/phycore_imx8mm -D__KERNEL__ -D__UBOOT__ -DCONFIG_SPL_BUILD -Wall -Wstrict-prototypes -Wno-format-security -fno-builtin -ffreestanding -std=gnu11 -fshort-wchar -fno-strict-aliasing -fno-PIE -Os -fno-stack-protector -fno-delete-null-pointer-checks -Wno-stringop-truncation -Wno-maybe-uninitialized -fmacro-prefix-map=../= -g -fstack-usage -Wno-format-nonliteral -Wno-address-of-packed-member -Wno-unused-but-set-variable -Werror=date-time -ffunction-sections -fdata-sections -D__ARM__ -mstrict-align -ffunction-sections -fdata-sections -fno-common -ffixed-r9 -fno-common -ffixed-x18 -pipe -march=armv8-a -D__LINUX_ARM_ARCH__=8 -mgeneral-regs-only    -DKBUILD_BASENAME='"spl"'  -DKBUILD_MODNAME='"spl"' -c -o spl/board/phytec/phycore_imx8mm/spl.o ../board/phytec/phycore_imx8mm/spl.c

source_spl/board/phytec/phycore_imx8mm/spl.o := ../board/phytec/phycore_imx8mm/spl.c

deps_spl/board/phytec/phycore_imx8mm/spl.o := \
    $(wildcard include/config/phycore/imx8mm/ram/size/fix.h) \
    $(wildcard include/config/phycore/imx8mm/ram/size/1gb.h) \
    $(wildcard include/config/phycore/imx8mm/ram/size/2gb.h) \
    $(wildcard include/config/phycore/imx8mm/ram/size/4gb.h) \
    $(wildcard include/config/sys/fsl/usdhc/num.h) \
    $(wildcard include/config/spl/usb/sdp/support.h) \
...
spl/board/phytec/phycore_imx8mm/spl.o: $(deps_spl/board/phytec/phycore_imx8mm/spl.o)
