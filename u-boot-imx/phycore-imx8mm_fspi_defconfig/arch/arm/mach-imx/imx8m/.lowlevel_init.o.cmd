cmd_arch/arm/mach-imx/imx8m/lowlevel_init.o := aarch64-phytec-linux-gcc  --sysroot=/home/jma/phytec_works/iMX8MM.test_image/build/tmp/work/phyboard_polis_imx8mm_4-phytec-linux/u-boot-imx/2021.04-r0/recipe-sysroot -Wp,-MD,arch/arm/mach-imx/imx8m/.lowlevel_init.o.d  -nostdinc -isystem /home/jma/phytec_works/iMX8MM.test_image/build/tmp/work/phyboard_polis_imx8mm_4-phytec-linux/u-boot-imx/2021.04-r0/recipe-sysroot-native/usr/bin/aarch64-phytec-linux/../../lib/aarch64-phytec-linux/gcc/aarch64-phytec-linux/10.2.0/include -Iinclude  -I../include  -I../arch/arm/include -include ../include/linux/kconfig.h -D__KERNEL__ -D__UBOOT__ -D__ASSEMBLY__ -fno-PIE -g -D__ARM__ -fno-pic -mstrict-align -ffunction-sections -fdata-sections -fno-common -ffixed-r9 -fno-common -ffixed-x18 -pipe -march=armv8-a -D__LINUX_ARM_ARCH__=8 -mgeneral-regs-only   -c -o arch/arm/mach-imx/imx8m/lowlevel_init.o ../arch/arm/mach-imx/imx8m/lowlevel_init.S

source_arch/arm/mach-imx/imx8m/lowlevel_init.o := ../arch/arm/mach-imx/imx8m/lowlevel_init.S

deps_arch/arm/mach-imx/imx8m/lowlevel_init.o := \
...
arch/arm/mach-imx/imx8m/lowlevel_init.o: $(deps_arch/arm/mach-imx/imx8m/lowlevel_init.o)
