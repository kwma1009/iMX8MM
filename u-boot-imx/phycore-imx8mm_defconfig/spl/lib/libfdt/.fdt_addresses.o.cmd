cmd_spl/lib/libfdt/fdt_addresses.o := aarch64-phytec-linux-gcc  --sysroot=/home/jma/phytec_works/iMX8MM.test_image/build/tmp/work/phyboard_polis_imx8mm_4-phytec-linux/u-boot-imx/2021.04-r0/recipe-sysroot -Wp,-MD,spl/lib/libfdt/.fdt_addresses.o.d  -nostdinc -isystem /home/jma/phytec_works/iMX8MM.test_image/build/tmp/work/phyboard_polis_imx8mm_4-phytec-linux/u-boot-imx/2021.04-r0/recipe-sysroot-native/usr/bin/aarch64-phytec-linux/../../lib/aarch64-phytec-linux/gcc/aarch64-phytec-linux/10.2.0/include -Ispl/include -Iinclude  -I../include  -I../arch/arm/include -include ../include/linux/kconfig.h  -I../lib/libfdt -Ispl/lib/libfdt -D__KERNEL__ -D__UBOOT__ -DCONFIG_SPL_BUILD -Wall -Wstrict-prototypes -Wno-format-security -fno-builtin -ffreestanding -std=gnu11 -fshort-wchar -fno-strict-aliasing -fno-PIE -Os -fno-stack-protector -fno-delete-null-pointer-checks -Wno-stringop-truncation -Wno-maybe-uninitialized -fmacro-prefix-map=../= -g -fstack-usage -Wno-format-nonliteral -Wno-address-of-packed-member -Wno-unused-but-set-variable -Werror=date-time -ffunction-sections -fdata-sections  -I../scripts/dtc/libfdt -DFDT_ASSUME_MASK=0xff -D__ARM__ -mstrict-align -ffunction-sections -fdata-sections -fno-common -ffixed-r9 -fno-common -ffixed-x18 -pipe -march=armv8-a -D__LINUX_ARM_ARCH__=8 -mgeneral-regs-only    -DKBUILD_BASENAME='"fdt_addresses"'  -DKBUILD_MODNAME='"fdt_addresses"' -c -o spl/lib/libfdt/fdt_addresses.o ../lib/libfdt/fdt_addresses.c

source_spl/lib/libfdt/fdt_addresses.o := ../lib/libfdt/fdt_addresses.c

deps_spl/lib/libfdt/fdt_addresses.o := \
...
spl/lib/libfdt/fdt_addresses.o: $(deps_spl/lib/libfdt/fdt_addresses.o)
