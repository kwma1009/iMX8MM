cmd_drivers/fastboot/fb_fsl/fb_fsl_command.o := aarch64-phytec-linux-gcc  --sysroot=/home/jma/phytec_works/iMX8MM.test_image/build/tmp/work/phyboard_polis_imx8mm_4-phytec-linux/u-boot-imx/2021.04-r0/recipe-sysroot -Wp,-MD,drivers/fastboot/fb_fsl/.fb_fsl_command.o.d  -nostdinc -isystem /home/jma/phytec_works/iMX8MM.test_image/build/tmp/work/phyboard_polis_imx8mm_4-phytec-linux/u-boot-imx/2021.04-r0/recipe-sysroot-native/usr/bin/aarch64-phytec-linux/../../lib/aarch64-phytec-linux/gcc/aarch64-phytec-linux/10.2.0/include -Iinclude  -I../include  -I../arch/arm/include -include ../include/linux/kconfig.h  -I../drivers/fastboot/fb_fsl -Idrivers/fastboot/fb_fsl -D__KERNEL__ -D__UBOOT__ -Wall -Wstrict-prototypes -Wno-format-security -fno-builtin -ffreestanding -std=gnu11 -fshort-wchar -fno-strict-aliasing -fno-PIE -Os -fno-stack-protector -fno-delete-null-pointer-checks -Wno-stringop-truncation -Wno-maybe-uninitialized -fmacro-prefix-map=../= -g -fstack-usage -Wno-format-nonliteral -Wno-address-of-packed-member -Wno-unused-but-set-variable -Werror=date-time  -I./lib -D__ARM__ -fno-pic -mstrict-align -ffunction-sections -fdata-sections -fno-common -ffixed-r9 -fno-common -ffixed-x18 -pipe -march=armv8-a -D__LINUX_ARM_ARCH__=8 -mgeneral-regs-only    -DKBUILD_BASENAME='"fb_fsl_command"'  -DKBUILD_MODNAME='"fb_fsl_command"' -c -o drivers/fastboot/fb_fsl/fb_fsl_command.o ../drivers/fastboot/fb_fsl/fb_fsl_command.c

source_drivers/fastboot/fb_fsl/fb_fsl_command.o := ../drivers/fastboot/fb_fsl/fb_fsl_command.c

deps_drivers/fastboot/fb_fsl/fb_fsl_command.o := \
    ...
    $(wildcard include/config/secure/unlock.h) \
    $(wildcard include/config/virtual/ab/support.h) \
    $(wildcard include/config/avb/atx.h) \
    $(wildcard include/config/at/authenticate/unlock.h) \
    $(wildcard include/config/fastboot/buf/size.h) \
    $(wildcard include/config/generate/mppubk.h) \
    $(wildcard include/config/id/attestation.h) \
...
drivers/fastboot/fb_fsl/fb_fsl_command.o: $(deps_drivers/fastboot/fb_fsl/fb_fsl_command.o)
